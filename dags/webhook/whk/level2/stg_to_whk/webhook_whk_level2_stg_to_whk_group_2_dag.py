...
CONFIG_PATH = Path("/opt/airflow/projects/webhook/whk/level2/stg_to_whk/webhook_whk_level2_stg_to_whk_group_2.yaml")
DAG_ID = "webhook_whk_level2_stg_to_whk_group_2_dag"
DAG_TAGS = ["webhook", "whk", "level2", "stg_to_whk"]
UPSTREAM_DAG_IDS = []
