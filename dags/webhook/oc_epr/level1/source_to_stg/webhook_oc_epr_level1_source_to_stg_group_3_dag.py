...
CONFIG_PATH = Path("/opt/airflow/projects/webhook/oc_epr/level1/source_to_stg/webhook_oc_epr_level1_source_to_stg_group_3.yaml")
DAG_ID = "webhook_oc_epr_level1_source_to_stg_group_3_dag"
DAG_TAGS = ["webhook", "oc_epr", "level1", "source_to_stg"]
UPSTREAM_DAG_IDS = []
